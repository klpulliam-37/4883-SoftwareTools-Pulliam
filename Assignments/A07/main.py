...
"""
for each table in tbody labeled "Days data", 
loop through its rows and store in a dictionary with matching categories



Example dictionary for weekly data:
Observations: {
    Time: {
        Dec: [
